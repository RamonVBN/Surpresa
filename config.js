...
const CONFIG = {
    ...
    valentineName: "Nycolle",

    // The title that appears in the browser tab
    // You can use emojis! 💝 💖 💗 💓 💞 💕
    pageTitle: "Para meu amor 💝",
    ...
    questions: {
        ...
        third: {
            text: "Eu sou o amor da sua vida? 🌹", // The big question!
            yesBtn: "Sim!",                                             // Text for "Yes" button
            noBtn: "Não"                                                 // Text for "No" button
        }
    },
    ...
    loveMessages: {
        extreme: "EITAAAAA PESTE, você me ama esse tantão?? 🥰🚀💝",  // Shows when they go past 5000%
        high: "Ao infinito e além! 🚀💝",              // Shows when they go past 1000%
        normal: "Mais!? 🥰"                           // Shows when they go past 100%
    },

    // Messages that appear after they say "Yes!"
    celebration: {
        title: "Aí sim! Eu sou a pessoa mais sortuda nesse mundo! 🎉💝💖💝💓",
        message: "Agora venha e pegue seu presente, um abração quente e um beijão gostoso!",
    ...
    music: {
        ...
        musicUrl: "./music/love-music.mp3", // Music streaming URL
